...
class AuthRepository {
  ...
  Future<UserModel> login({
    ...
    try {
      ...
      // CORRIGIDO: Convertendo String para DateTime
      final createdAt = response.user!.createdAt != null ? DateTime.parse(response.user!.createdAt!) : null;
      final updatedAt = response.user!.updatedAt != null ? DateTime.parse(response.user!.updatedAt!) : null;
